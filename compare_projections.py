...
s_C2B = np.array([[0.997685, -0.0513317, -0.0446062, -0.442201],\
                [-0.0544216, -0.995986, -0.0710655, -0.0533749],\
                [-0.0407792, 0.0733285, -0.996474, 1.08592],\
                [0, 0, 0, 1]])
s_C2I = np.array([[1690.07628, 0, 538.004444], [0, 1683.10289, 370.217221], [0, 0, 1]])

w_W2B = np.array(robot.get_pose().array)
w_C2W = np.array([[0.999253, 0.0257298, -0.0147478, -0.0792376],\
                [-0.026016, 0.999159, -0.0196156, -0.1547293],\
                [0.0140345, 0.0201321, 0.999699, 0.016827],\
                [0, 0, 0, 1]])
