...
class COCOSegmentation(Dataset):
    ...
    def __init__(self,
        ...
        ann_file = os.path.join(base_dir, 'handai_annotations_{}.json'.format(split))
        ids_file = os.path.join(base_dir, 'handai_ann_ids_{}.pth'.format(split))

        #self.img_dir = os.path.join(base_dir, 'images/{}{}'.format(split, year))
        self.img_dir = os.path.join(base_dir, 'handai_dataset_img_{}'.format(split))
