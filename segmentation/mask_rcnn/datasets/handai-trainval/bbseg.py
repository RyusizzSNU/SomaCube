...
def main():
  ...
  prs.add_argument("-d", "--dataset_path", type=str, default='handai_dataset_img')
  prs.add_argument("-a", "--annotation", type=str, default='handai_annotations.json')
  prs.add_argument("-o", "--output_path", type=str, default='handai_dataset_ann')
  prs.add_argument("-n", "--output_name", type=str, default='out.json')
  prs.add_argument("-s", "--start_index", type=int, default=0)
  prs.add_argument("-e", "--end_index", type=int, default=200)
